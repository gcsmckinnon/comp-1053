...
class @CardSort
  ...
  addGroup: ->
    ...
    label = $('<div >', {'class': 'label'}).append('<i class="fa fa-arrows ui-draggable-handle">&nbsp;</i><span class="editable" contentEditable>Label&nbsp;<i class="fa fa-pencil"></i></span>&nbsp;<i class="deleteGroup fa fa-remove"></i>')

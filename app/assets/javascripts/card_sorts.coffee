$(document).on 'turbolinks:load', ->
  if top.location.pathname == '/card_sorts/new' or top.location.pathname.match(/\/card_sorts\/\d+\/edit/i)
    ...
    $('.addCard').on 'click', ->
      ...
      cardTemplate = $('<input />', 'class': 'string optional card form-control', 'placeholder': 'new card', 'name': 'card_sorts[cards][]', 'type': 'text', 'id': 'card_sort_cards')
      console.log cardTemplate
      cardTemplate.appendTo '.cards'
      # return

  # if top.location.pathname.match(/\/card_sorts\/\d+/i) &~ top.location.pathname.match(/\/card_sorts\/\d+\/edit/i)
  #   console.log "Playing the card sort"
